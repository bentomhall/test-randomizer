...
def main(input_file, subject, exam_name, date, index=0, condensed=False, verbose=False, includeFile=None, showBlank=False, scriptDir=''):
    template = load_template(os.path.join(scriptDir, "assessment.template.tex"), subject, exam_name, date, index)
